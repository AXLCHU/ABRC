...
spots = [i/10 + 0.5 for i in range(11)]
# spots = [i/20 + 0.5 for i in range(21)]
...
# Prices
plt.plot(autocall_geo['St'], autocall_geo['P'], label='GBM', linewidth=0.8)
...
plt.savefig(r'C:\Users\axelc\OneDrive\Documents\PY\ABRC\output\plots\abrc_price.jpg')
plt.show()
plt.close()

# Deltas
plt.plot(delta_geo['St'], delta_geo['Delta'], label='GBM', linewidth=0.8)
...
plt.savefig(r'C:\Users\axelc\OneDrive\Documents\PY\ABRC\output\plots\abrc_delta.jpg')
plt.show()
plt.close()
...
# Vegas
plt.plot(vega_geo['St'], vega_geo['Vega'], label='GBM', linewidth=0.8)
...
plt.savefig(r'C:\Users\axelc\OneDrive\Documents\PY\ABRC\output\plots\abrc_vega.jpg')
plt.show()
plt.close()
